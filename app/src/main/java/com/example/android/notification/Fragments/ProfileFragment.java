...
import com.example.android.notification.ContactsActivity;
import com.example.android.notification.PocketMain;
import com.example.android.notification.R;
import com.example.android.notification.RequestsActitvity;
...
public class ProfileFragment extends Fragment {
    ...
    mUserId=mAuth.getCurrentUser().getUid();
        ...
        contacts = (TextView)view.findViewById(R.id.my_contacts);
        contacts.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(container.getContext(), ContactsActivity.class);
                startActivity(intent);
            }
        });
        requests=(TextView)view.findViewById(R.id.my_requests);
        requests.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(container.getContext(),RequestsActitvity.class);
                startActivity(i);
            }
        });
