        ...
        mSendBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!TextUtils.isEmpty(message)){
                    ...
                    Map<String,Object> notificationMessageTo=new HashMap<>();
                    notificationMessageTo.put("Message",message);
                    notificationMessageTo.put("To",mUserId);
                    ...
                    mFirestore.collection("Users/" + mCurrentId + "/Notifications To" ).add(notificationMessageTo).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                        @Override
                        public void onSuccess(DocumentReference documentReference) {
                            Toast.makeText(SendActivity.this,"Notification Saved",Toast.LENGTH_SHORT).show();
                            mMessageProgress.setVisibility(View.INVISIBLE);
                        }
                    }).addOnFailureListener(new OnFailureListener() {
                        @Override
